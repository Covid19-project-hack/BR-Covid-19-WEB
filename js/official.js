$(document).ready(function(){
    ...
    var testlabs = (function() {
        ...
        $.ajax({
          'async': false,
          'global': false,
          'url': "json/official_directories.json",
          'dataType': "json",
          'success': function(data) {
            json = data;
          }
    ...
    <br>
    <p class="mb-1"><i class="fas fa-tag" style="margin-right: 15px;"> </i>   ${element.dc}</p>
    <p class="mb-1"><i class="fas fa-tag" style="margin-right: 15px;"> </i>   ${element.si}</p>
    <p class="mb-1"><i class="fas fa-tag" style="margin-right: 15px;"> </i>   ${element.dmos}</p>
    </div>`;
    });   
});